...
<body class="hold-transition skin-purple sidebar-mini">
			...
			<form action="${pageContext.request.contextPath}/user/update.do"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<select class="form-control " id="statu" style="width: 100%" name="status">
								<option value="0" selected="selected">关闭</option>
								<option value="1">开启</option>
							</select>
						</div>
						<div class="col-md-2 title">关联的角色</div>
						<div class="col-md-4 data">
							<a href="${pageContext.request.contextPath}/user/editRoleByUserId.do" class="btn btn-default" >编辑</a>
						</div>
	...
	<script>
		...
		$(function () {
			...
			if (statu=="0"){
				$("#statu option[value='0']").attr("selected",true);
				$("#statu option[value='1']").attr("selected",false);
			}
			if(statu=="1") {
				$("#statu option[value='0']").attr("selected",false);
