	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="订单状态"
							   value="${orders.orderStatusStr}">
					</div>

					<div class="col-md-2 title">其他信息</div>
					<div class="col-md-4 data">
						<input class="form-control" rows="3" placeholder="其他信息"
							   value="${orders.orderDesc }">
					</div>
				...
				<table id="dataList"
					...
					<tbody>
						<c:forEach var="traveller" items="${orders.travellers}">
							...
							<tr>
								<td><input type="text" size="10" value="${traveller.travellerTypeStr }"></td>
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="会员"
							   value="${orders.member.nickname }">
					</div>

					<div class="col-md-2 title">联系人</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="联系人"
							   value="${orders.member.name}">
					</div>

					<div class="col-md-2 title">手机号</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="手机号"
							   value="${orders.member.phoneNum}">
					</div>

					<div class="col-md-2 title">邮箱</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="邮箱"
							   value="${orders.member.email}">
					</div>
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="支付方式"
								   value="在线支付-${orders.payTypeStr}">
						</div>

						<div class="col-md-2 title">金额</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="金额"
								   value="￥${orders.product.productPrice}">
						</div>
			...
			<div class="box-tools text-center">
				...
				<button type="button" class="btn bg-primary" onclick="">保存</button>
