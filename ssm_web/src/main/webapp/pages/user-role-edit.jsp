...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				用户管理 <small>编辑角色表单</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a
					href="#" onclick="history.back(-1);">用户编辑</a></li>
				<li class="active">编辑角色表单</li>
			</ol>
			</section>
			<!-- 内容头部 /-->
							...
							<tbody>
								<c:forEach items="${roleList}" var="role">
									<tr>
										...
										<input name="ids" type="checkbox" value="${role.id}" onclick="checkOnclick(this)">
