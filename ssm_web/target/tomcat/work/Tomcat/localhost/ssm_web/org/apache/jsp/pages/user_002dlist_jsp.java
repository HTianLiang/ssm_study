 ...
 * Generated at: 2019-10-16 07:22:45 UTC
...
public final class user_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-default\" title=\"状态开启\" onclick=\"openStatu()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-check-circle\"></i> 开启\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-default\" title=\"状态关闭\" onclick=\"closeStatu()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-window-close\"></i> 关闭\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"text-center\" style=\"padding-right: 0px\">选择用户</th>\r\n");
      ...
      out.write("\t\t\t\t/*var arrId = [];\r\n");
      out.write("\t\t\t\t//判断name=Uid的input框是否选中，若选中则将其value值追加到数组arrId中\r\n");
      out.write("\t\t\t\t$(\"input[name='Uid']:checked\").each(function () {\r\n");
      out.write("\t\t\t\t\tarrId.push($(this).val());\r\n");
      out.write("\t\t\t\t})*/\r\n");
      out.write("\t\t\t\tif (confirm(\"你确定要删除该用户吗？\")){\r\n");
      out.write("\t\t\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/delete.do\",{\"id\":id},function (data) {\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t//开启关闭事件  状态0 未开启 1 开启\r\n");
      out.write("\t\t\tfunction openStatu() {\r\n");
      out.write("\t\t\t\tvar arrStatu = [];\r\n");
      out.write("\t\t\t\tif ($(\"input[name='Ustatu']\").is(':checked')){\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t//判断name=Uid的input框是否选中，若选中则将其value值追加到数组arrId中\r\n");
      out.write("\t\t\t\t\t$(\"input[name='Ustatu']:checked\").each(function () {\r\n");
      out.write("\t\t\t\t\t\tarrStatu.push($(this).val());\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\tif (arrStatu==\"开启\"){\r\n");
      out.write("\t\t\t\t\t\t\talert(\"该项已是开启状态,请选择未开启状态的选项！\")\r\n");
      out.write("\t\t\t\t\t\t}else {\r\n");
      out.write("\t\t\t\t\t\t\t//获取选中行的用户id id在tr标签下td标签的第二列\r\n");
      out.write("\t\t\t\t\t\t\tvar Uid = $(this).parents('tr').children().eq(1).text();\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/open.do?id=\"+Uid,function (data) {\r\n");
      out.write("\t\t\t\t\t\t\t\twindow.location.reload();\r\n");
      out.write("\t\t\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t}else {\r\n");
      out.write("\t\t\t\t\talert(\"请选择你要开启的用户！\")\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfunction closeStatu() {\r\n");
      out.write("\t\t\t\tvar arrStatu = [];\r\n");
      out.write("\t\t\t\tif ($(\"input[name='Ustatu']\").is(':checked')){\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t//判断name=Uid的input框是否选中，若选中则将其value值追加到数组arrId中\r\n");
      ...
      out.write("\t\t\t\t\t\tarrStatu.push($(this).val());\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\tif (arrStatu==\"未开启\"){\r\n");
      out.write("\t\t\t\t\t\t\talert(\"该项已是未开启状态,请选择开启状态的选项！\")\r\n");
      out.write("\t\t\t\t\t\t}else {\r\n");
      out.write("\t\t\t\t\t\t\t//获取选中行的用户id id在tr标签下td标签的第二列\r\n");
      out.write("\t\t\t\t\t\t\tvar Uid = $(this).parents('tr').children().eq(1).text();\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/close.do?id=\"+Uid,function (data) {\r\n");
      out.write("\t\t\t\t\t\t\t\twindow.location.reload();\r\n");
      out.write("\t\t\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t}else {\r\n");
      out.write("\t\t\t\t\talert(\"请选择你要关闭的用户！\")\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /pages/user-list.jsp(151,9) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/pages/user-list.jsp(151,9) '${pageInfo.list}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${pageInfo.list}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /pages/user-list.jsp(151,9) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"Ustatu\" type=\"radio\" value=\"");
          ...
          out.write("</td>\t\t\t\t\t\t\t\t\t\t\t\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-center\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"btn btn-danger btn-xs\" onclick=\"deleteUser(");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write(")\">删除</a>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("/user/editById.do?id=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.id }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /pages/user-list.jsp(213,32) name = begin type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setBegin(1);
    // /pages/user-list.jsp(213,32) name = end type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /pages/user-list.jsp(213,32) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
